  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "y2k-mesh": `radial-gradient(at 40% 20%, hsla(330, 100%, 71%, 0.3) 0px, transparent 50%),
                     ...
                     radial-gradient(at 0% 100%, hsla(187, 99%, 50%, 0.15) 0px, transparent 50%)`,
        "synthwave": "linear-gradient(180deg, #FFD319 0%, #FF901F 25%, #FF2975 50%, #F222FF 75%, #8C1EFF 100%)",
      ...
      keyframes: {
        ...
        "mesh-move": {
          "0%": { backgroundPosition: "0% 0%, 100% 100%, 0% 50%, 100% 50%, 0% 100%" },
          "50%": { backgroundPosition: "100% 100%, 0% 0%, 100% 50%, 0% 50%, 100% 0%" },
          "100%": { backgroundPosition: "0% 0%, 100% 100%, 0% 50%, 100% 50%, 0% 100%" },
        },
        "reveal": {
